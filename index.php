  ...
  <div class="modal-dialog">
        ...
        <form method="POST" id="formulario" enctype="multipart/form-data">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <label for="telefono">Ingrese el telefono1</label>
                    <input type="text" name="telefono" id="telefono" class="form-control">
                    <br />
                    <label for="telefono2">Ingrese el telefono2</label>
                    <input type="text" name="telefono2" id="telefono2" class="form-control">
                    <br />
                    <label for="email">Ingrese el email</label>
                    <input type="email" name="email" id="email" class="form-control">
                    <br />
                    <label for="direccion_casa">Ingrese la direccion casa</label>
                    <textarea name="direccion_casa" id="direccion_casa" cols="30" rows="10" class="form-control"></textarea>
                    <br />
                    <label for="direccion_trabajo">Ingrese la direccion trabajo</label>
                    <textarea name="direccion_trabajo" id="direccion_trabajo" cols="30" rows="10" class="form-control"></textarea>
                    <br />
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            var direccion_trabajo = $('#direccion_trabajo').val();
                ...
                success:function(data)
                    {
                        ...
                        $('#direccion_casa').val(data.direccion_casa);
                        $('#direccion_trabajo').val(data.direccion_trabajo);
